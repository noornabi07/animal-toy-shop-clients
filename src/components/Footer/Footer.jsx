...
import { FaBeer, FaFacebook, FaGithub, FaGoogle, FaInstagram, FaLocationArrow, FaMap, FaMapMarked, FaMapMarkedAlt, FaMobile, FaPhoneSquare, FaTwitter } from 'react-icons/fa';
